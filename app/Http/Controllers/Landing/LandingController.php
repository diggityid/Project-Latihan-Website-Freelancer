...
class LandingController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        $thumbnail = ThumbnailService::where('id', $id)->get();
        $advantage_user = AdvantageUser::where('id', $id)->get();
        $advantage_service = AdvantageService::where('id', $id)->get();
        $tagline = Tagline::where('id', $id)->get();
