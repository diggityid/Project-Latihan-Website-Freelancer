                                ...
                                <table class="w-full" aria-label="Table">
                                    ...
                                    <tbody class="bg-white">
                                        <tr class="text-gray-700 border-b">
                                            <td class="w-2/6 px-1 py-5">
                                                <div class="flex items-center text-sm">
                                                    ...
                                                    <div>
                                                        <!-- <a href="{{ route('member.service.create') }}" class="font-medium text-black"> -->
                                        ...
                                        <tr class="text-gray-700 border-b">
                                            ...
                                            <td class="px-1 py-5 text-sm">
                                                <!-- <a href="/dashboard/services/edit.php" class="px-4 py-2 mt-2 text-left text-white rounded-xl 
                                                bg-serv-email"> -->
                                                <a href="{{ route('member.service.edit',1) }}" class="px-4 py-2 mt-2 text-left text-white rounded-xl 
                                                bg-serv-email">
                                                    Edit Service
                                                </a>
                                            </td>
