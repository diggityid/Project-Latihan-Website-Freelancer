...
Route::group(['prefix' => 'member', 'as' => 'member.', 'middleware' => ['auth:scantum', 'verified']], function(){
=======
/*
|--------------------------------------------------------------------------
| Web Routes
...
Route::group(['prefix' => 'member', 'as' => 'member.', 'middleware' => ['auth:scantum', 'verified']],
function(){
...
=======
    ...
    Route::get('accept/order/{id}', MyOrderController::class, 'accepted')->name('accept.order');
    Route::get('reject/order/{id}', MyOrderController::class, 'rejected')->name('reject.order');
    Route::order('request', MyOrderController::class);

    //profile
    Route::get('delete_photo', ProfileController::class, 'delete')->name('delete.photo.profile');
    Route::order('profile', ProfileController::class);
